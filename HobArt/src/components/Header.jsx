  ...
  return (
    <header className="main-header">
      <div className="header-inner">
        ...
        {/* Right-side area: accessibility + utility icons */}
        <div className="right-area">
          ...
          {/* utility icons: profile, search, cart */}
      ...
      {/* Navigation (moved back below header) */}
        ...
        <ul className="nav-list">
          ...
          <li className="has-submenu" onMouseLeave={() => setShopOpen(false)}>
            ...
            <ul className={`submenu ${shopOpen ? "open" : ""}`}>
              <li><Link to="/products/decoration-candle">Decoration Candle</Link></li>
              <li><Link to="/products/epoxy-decor">Epoxy Decor</Link></li>
              <li><Link to="/products/holiday-decor">Holiday Decor</Link></li>
              <li><Link to="/products/accessories">Accessories</Link></li>
              <li><Link to="/products/plaster-decor">Plaster Decor</Link></li>
              <li><Link to="/products/felt-toys">Felt Toys</Link></li>
            </ul>
          </li>
        </ul>
      </nav>
